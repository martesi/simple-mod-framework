...
export function wineCommand(command: string, toolsRoot: string): { command: string; env: NodeJS.ProcessEnv } {
...
export function wineArgv(exePath: string, args: string[], toolsRoot: string): { command: string; args: string[]; env: NodeJS.ProcessEnv } {
